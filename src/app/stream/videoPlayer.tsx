...
export default function VideoPlayerClient({ videos }: { videos: ChallengeData[] }) {
    ...
    function nextVideo() {
        ...
        const nextVideoIndex = currentIndex < videos.length-1 && currentIndex >= 0 ? currentIndex+1 : 0;
